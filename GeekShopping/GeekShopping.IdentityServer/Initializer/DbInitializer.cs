...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            //Criação do usuário admin na base de dados
            ApplicationUser admin = new ApplicationUser()
            {
                UserName = "vinicius-admin",
                Email = "vinicius-admin@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (14) 98230-1615",
                FirstName = "Vinicius",
                LastName = "Admin"
            };
            ...
            //Criação de um usuário client na base de dados
            ApplicationUser client = new ApplicationUser()
            {
                UserName = "vinicius-client",
                Email = "vinicius-client@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (14) 98230-1615",
                FirstName = "Vinicius",
                LastName = "Client"
