...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO cartVO)
        {
            ...
            var cartHeader = await _context.CartHeaders.AsNoTracking() //EF does not track this object for updates. Causing a performance improvement
            ...
            else
            {
                ...
                var cartDetail = await _context.CartDetails.AsNoTracking()
                    .FirstOrDefaultAsync(c => c.ProductId == cartVO.CartDetails.FirstOrDefault().ProductId && c.CartHeaderId == cartHeader.Id);
